        ...
        <section id="tab-tasks" class="tab-content hidden flex flex-col gap-6">
            ...
            <div class="glass-panel p-4 rounded-lg flex flex-col md:flex-row justify-between items-center gap-4">
                <div class="flex flex-wrap gap-2">
                    ...
                    <button onclick="setTaskFilter('Shopifydevstudio')" id="task-filter-studio" class="bg-zinc-950 hover:bg-zinc-900 border border-brand-border text-zinc-400 font-extrabold text-[9px] uppercase tracking-wider py-2 px-4 rounded transition-all">Shopifydevstudio Tasks</button>
                </div>
        ...
        <section id="tab-chats" class="tab-content hidden grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            <div class="lg:col-span-1 glass-panel p-5 rounded-lg flex flex-col gap-4 h-fit">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <button onclick="filterChatBySender('Shopifydevstudio')" id="chat-filter-studio" class="bg-zinc-950 hover:bg-zinc-900 border border-brand-border text-zinc-400 font-extrabold text-[9px] uppercase tracking-wider py-2 px-3 rounded text-left transition-all">Filter by Shopifydevstudio</button>
                </div>
            </div>
    ...
    <script>
        ...
        function renderTasks() {
            ...
            filteredTasks.forEach(task => {
                ...
                const ownerHtml = `<span class="border px-2 py-0.5 font-black uppercase rounded text-[9px] tracking-wide ${badgeClass}">${task.owner === 'Nathan' ? 'Nathan' : 'Shopifydevstudio'}</span>`;
